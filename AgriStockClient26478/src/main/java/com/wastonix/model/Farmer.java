...
public class Farmer implements Serializable {
    ...
    private transient Set<Harvest> harvests = new HashSet<>();

    
    @OneToMany(mappedBy = "farmer", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    private transient Set<Sale> sales = new HashSet<>();
    ...
    private transient Set<Cooperative> cooperatives = new HashSet<>();
